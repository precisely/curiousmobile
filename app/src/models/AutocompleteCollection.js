define(['require', 'exports', 'module', 'jstzdetect', 'exoskeleton', 'models/Entry', 'jscache'],
    function(require, exports, module, jstz, exoskeleton, Autocomplete, Cache) {
        ...
        AutocompleteCollection.fetch = function(callback) {
...
//                            });
        ...
        AutocompleteCollection.getFromCache = function(key){
